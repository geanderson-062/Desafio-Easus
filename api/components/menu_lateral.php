   <!--navbar-->
   <header class="navbar navbar-dark sticky-top flex-md-nowrap p-0 shadow" style="background-color: #f7f5f6;">
       <nav class="navbar bg-body-tertiary">
           <div class="container">
               <a class="navbar-brand" href="#">
                   <img src="../assets/img/favicon/1.svg" alt="Bootstrap" width="30" height="30">
                   ESUS
               </a>
           </div>
       </nav>
   ...
   <div class="container-fluid">
       <div class="row">
           <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block  sidebar collapse" style="background-color: #f7f5f6;">
               <div class="position-sticky pt-3 sidebar-sticky">
                   <ul class="nav flex-column">
                       <li class="nav-item">
                           <a class="nav-link active" aria-current="page" href="../screens/home.php">
                       ...
                       <li class="nav-item">
                           <a class="nav-link" href="../screens/capitacao.php">
                       ...
                       <li class="nav-item">
                           <a class="nav-link" href="../screens/desempenho.php">
                       ...
                       <li class="nav-item">
                           <a class="nav-link" href="../screens/producao.php">
                       ...
                       <li class="nav-item">
                           <a class="nav-link" href="../screens/usuario.php">
                       ...
                       <li class="nav-item">
                           <a class="nav-link" href="../screens/alterar_senha.php">
                       ...
                       <li class="nav-item">
                           <a class="nav-link text-danger" href="../screens/login.php">
